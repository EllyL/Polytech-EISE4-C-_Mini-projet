#############################################################################
# Makefile for building: Polytech-EISE4-C-_Mini-projet
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  Polytech-EISE4-C-_Mini-projet.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile Polytech-EISE4-C-_Mini-projet.pro
#############################################################################
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		Polytech-EISE4-C-_Mini-projet.pro \
		Polytech-EISE4-C-_Mini-projet.pro
QMAKE_TARGET  = Polytech-EISE4-C-_Mini-projet
...
Makefile: Polytech-EISE4-C-_Mini-projet.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Polytech-EISE4-C-_Mini-projet.pro
...
dist: 
	@test -d .tmp/Polytech-EISE4-C-_Mini-projet1.0.0 || mkdir -p .tmp/Polytech-EISE4-C-_Mini-projet1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Polytech-EISE4-C-_Mini-projet1.0.0/ && $(COPY_FILE) --parents bonus.hh carte.hh chemin.hh composantM.hh fantome.hh fenetre.hh jeu.hh joueur.hh objet.hh obstacle.hh personnage.hh prison.hh vote.hh .tmp/Polytech-EISE4-C-_Mini-projet1.0.0/ && $(COPY_FILE) --parents bonus.cc carte.cc chemin.cc composantM.cc fantome.cc fenetre.cc joueur.cc main.cc obstacle.cc prison.cc vote.cc .tmp/Polytech-EISE4-C-_Mini-projet1.0.0/ && (cd `dirname .tmp/Polytech-EISE4-C-_Mini-projet1.0.0` && $(TAR) Polytech-EISE4-C-_Mini-projet1.0.0.tar Polytech-EISE4-C-_Mini-projet1.0.0 && $(COMPRESS) Polytech-EISE4-C-_Mini-projet1.0.0.tar) && $(MOVE) `dirname .tmp/Polytech-EISE4-C-_Mini-projet1.0.0`/Polytech-EISE4-C-_Mini-projet1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Polytech-EISE4-C-_Mini-projet1.0.0
...
bonus.o: bonus.cc bonus.hh \
		objet.hh \
		composantM.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bonus.o bonus.cc
...
carte.o: carte.cc carte.hh \
		...
		chemin.hh \
		obstacle.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o carte.o carte.cc

chemin.o: chemin.cc chemin.hh \
		composantM.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o chemin.o chemin.cc

composantM.o: composantM.cc composantM.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o composantM.o composantM.cc

fantome.o: fantome.cc fantome.hh \
		personnage.hh \
		composantM.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fantome.o fantome.cc
...
fenetre.o: fenetre.cc fenetre.hh \
		...
		chemin.hh \
		obstacle.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fenetre.o fenetre.cc

joueur.o: joueur.cc joueur.hh \
		personnage.hh \
		composantM.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o joueur.o joueur.cc

main.o: main.cc composantM.hh \
		personnage.hh \
		joueur.hh \
		fantome.hh \
		obstacle.hh \
...
obstacle.o: obstacle.cc obstacle.hh \
		composantM.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obstacle.o obstacle.cc

prison.o: prison.cc prison.hh \
		objet.hh \
		composantM.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o prison.o prison.cc

vote.o: vote.cc vote.hh \
		objet.hh \
		composantM.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o vote.o vote.cc
